...
`bryan25@htb[/htb]$ sqlmap -hh ...SNIP...   Techniques:     --technique=TECH..  SQL injection techniques to use (default "BEUSTQ")`
...
Next:[[Getting Started with SQLMap]]