...
`bryan25@htb[/htb]$ git clone https://github.com/s0md3v/XSStrike.git bryan25@htb[/htb]$ cd XSStrike bryan25@htb[/htb]$ pip install -r requirements.txt bryan25@htb[/htb]$ python xsstrike.py XSStrike v3.1.4 ...SNIP...`
